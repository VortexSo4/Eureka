...
namespace PhysicsSimulation.Scenes.Built_In_Scenes
{
    public class SimulationScene1 : Scene
    {
        protected override void StartSlides()
        {
            ...
            var label = new Text("PHYSICS SIMULATION", y: 0.7f, fontSize: 0.1f, color: new Vector3(1f, 1f, 1f), filled:true);
            ...
            Wait(3f);
            label.MorphTo(new Text("END OF SIMULATION", fontSize: 0.1f, color: new Vector3(1f, 1f, 1f), filled:true));
        }
    }
}